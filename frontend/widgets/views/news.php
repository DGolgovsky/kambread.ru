<div class="col-lg-5 col-md-5 col-sm-12 hidden-xs">
	...
	<div id="myCarousel" class="carousel slide" style="height: 350px;">
		...
		<div class="carousel-inner">
			<?php $i = 0; foreach ($result as $rec): ?>
			<div class="item <?= ($i == 0) ? 'active' : '' ?>">
				<h5 style="text-indent: 20px;">
					<a href="<?= \frontend\components\Common::getUrlNews($rec) ?>">
						<?= \frontend\components\Common::getTitle($rec) ?>
					</a>
				</h5>
				<div class="pull-left bg-default" style="width: 20em; padding-right: 15px;">
				...
				<p><?= \frontend\components\Common::substr($rec['description'], 0, 300) ?></p>
			</div>
			<?php $i++; endforeach; ?>
		</div>
	</div>
