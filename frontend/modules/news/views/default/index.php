        ...
        <div class="row">
            <div class="col-lg-12 col-sm-12 col-xs-12">
                ...
                foreach ($model as $row):
                    ...
                    <!-- news list -->
                    <div class="row">
                        <div class="col-lg-4 col-sm-4 "><a href="<?= $url ?>" class="thumbnail"><img
                                    src="<?= \frontend\components\Common::getImageNews($row)[0] ?>"
                        ...
                        <div class="col-lg-8 col-sm-8 ">
                            ...
                            <div class="info"><span class="glyphicon glyphicon-time"></span>
                                Создано: <?= \frontend\components\Common::getCreationDate($row) ?></div>
