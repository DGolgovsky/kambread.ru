    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-3 col-xs-12">
            ...
            <dl class="text-left dl-horizontal foot">
                <dt>Отдел продаж</dt>
                <dd style="text-align: right"><a href="mailto:marketing@kambread.ru" target="_self">marketing@kambread.ru</a>
                </dd>
                <dt>Отдел сбыта
                <dt>
                <dd style="text-align: right"><a href="mailto:expedition@kambread.ru" target="_self">expedition@kambread.ru</a>
                </dd>
                <dt>Web-master</dt>
                <dd style="text-align: right"><a href="mailto:support@kambread.ru"
                                                 target="_self">support@kambread.ru</a></dd>
            </dl>
        </div>
    </div>
    <p style="text-align: center">Полный ассортимент продукции и цены Вы можете уточнить у менеджеров <a
            href="/contact">отдела маркетинга</a></p>
</div>
